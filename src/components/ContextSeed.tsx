    ...
    <div className="mt-6 max-w-3xl border-t border-[var(--d-line)] pt-6">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-4">
        <button
          ...
          onClick={copy}
          disabled={!message}
          className="inline-flex items-center gap-2 rounded-full bg-[var(--d-teal)] px-5 py-2.5 text-sm font-medium text-white transition hover:bg-[var(--d-teal-dark)] disabled:cursor-not-allowed disabled:opacity-40"
        >
          {copied ? (
